...
var FwutiaokuangScene = (function (_super) {
    __extends(FwutiaokuangScene, _super);
    function FwutiaokuangScene() {
        var _this = _super.call(this) || this;
        _this.addEventListener(eui.UIEvent.COMPLETE, _this.onComplete, _this);
        _this.skinName = "resource/wnd/FWTKWnd.exml";
        return _this;
    }
    FwutiaokuangScene.prototype.onComplete = function () {
        this.init();
        this.initListener();
    };
    FwutiaokuangScene.prototype.init = function () {
    ...
    FwutiaokuangScene.prototype.initListener = function () {
        this.rectBack.addEventListener(egret.TouchEvent.TOUCH_TAP, this.HandleBackClick, this);
    };
    //返回
    FwutiaokuangScene.prototype.HandleBackClick = function (e) {
        this.visible = false;
    };
    FwutiaokuangScene.prototype.release = function () {
        this.rectBack.removeEventListener(egret.TouchEvent.TOUCH_TAP, this.HandleBackClick, this);
    };
    return FwutiaokuangScene;
}(WinBase));
__reflect(FwutiaokuangScene.prototype, "FwutiaokuangScene");
//# sourceMappingURL=FwutiaokuangScene.js.map